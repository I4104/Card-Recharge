                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li><a href="history/doithe.php">Đổi thẻ</a></li>
                                <li><a href="history/withdraw.php">Rút tiền</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="history/doithe.php">Đổi thẻ</a>
                                </li>
                                <li>
                                    <a href="history/withdraw.php">Rút tiền</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
